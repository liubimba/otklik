...
class LetterCleaner:
    ...
    снижает частоту, но не убирает их — все четыре испытанные модели
    вероятностно добавляли `С уважением, [Ваше имя]` или выдумывали подпись.
    Поэтому чистим кодом, а не уговорами.
